...
/*
 * Returns Protein instance associated with current document.
 */
...
/*
 * Returns Protein instance associated with html tag in current document.
 */
...
/*
 * Returns Protein instance associated with head tag in current document.
 */
Protein.prototype.head = function() {
	var topElement = $("head");
	return new Protein(topElement, null).open();
};

/*
 * Returns Protein instance associated with body tag in current document.
 */
